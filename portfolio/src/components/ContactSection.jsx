import { Linkedin, Github, Send, Mail, MapPin, Phone } from "lucide-react";
        ...
        <section
            ...
            <div className="container mx-auto max-w-6xl">
                ...
                <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    I&apos;m always open to discussing analytics projects, internships, or opportunities to turn data into decisions. Feel free to reach out using the contact details below or by filling out the message form.
                </p>
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4 justify-center">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:sethiabhi15@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">sethiabhi15@gmail.com</a>
                                </div>
                            </div>
                            <div className="flex items-start space-x-9 justify-center">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+919579524107" className="text-muted-foreground hover:text-primary transition-colors">+91 9579524107</a>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4 justify-center">
                                <div className="p-3 rounded-full bg-primary/10">
                                ...
                                <div>
                                    ...
                                    <a className="text-muted-foreground hover:text-primary transition-colors">Maharashtra, India</a>
                                </div>
                            </div>
                        </div>
